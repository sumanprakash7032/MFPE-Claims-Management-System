...
public class JwtRequestFilterTest {
	...
	@Test
	public void testDoFilterInternalPositiveScenarioWhenTokenIsInHeader(){
		...
		mockHttpServletRequest.setRequestURI(testUri);
		MockHttpServletResponse response = new MockHttpServletResponse();
		MockFilterChain filterChain = new MockFilterChain();
		when(jwtUtilService.generateToken(userDetails)).thenReturn(testUri);
